...
const worker1 = new Worker("Имя", "Фамилия");
...
class Worker {
  ...
  fullName() {
    return (`Worker info: surname: ${this.surname}, name: ${this.name}`);
  }
}
...
const car = new Car("Brand", "Model", 2022);
console.log(car);
//Ваш код
...
const student = new Student("Имя", "Возраст", "Оценка");
const student2 = new Student("Имя", "Возраст", 3);
...
const book = new Book("Название", "Автор", "год");
console.log(book);
...
const book2 = new Book("Название книги", "Автор", 2023);
...
const account = new BankAccount(2023, 200000);
console.log(account);
...
const account2 = new BankAccount(2023, 2000);
...
class BankAccount {
  ...
  withdraw(amount) {
    if (amount <= this.balance) {
      return this.balance - 100; //Уменьшите баланс на заданную сумму
    } else {
...
console.log(account3.withdraw(1000));
...
const animal = new Animal("Имя", "Звук");
console.log(animal);
...
const animal2 = new Animal("Имя", "Звук");
...
const person2 = new Person("Имя", "Возраст", "Город");
...
const employee2 = new Employee("Имя", "Должность", 100000);
...
const product = new Product("Имя", "Цена", "Количество");
console.log(product);
...
const product2 = new Product("Имя", 10, 5);
